class AnswerStatus
  ...
  ALL_STATUSES = STATUSES.merge( {:institutionalized  => "Posredovano ustanovi", :archive => "Arhivirano, poslano napačni ustanovi" } )
  ...
  class << self
    ...
    def find_among_all(id)
      return unless id.present? and ALL_STATUSES.include?(id.to_sym)
      id = id.to_sym
