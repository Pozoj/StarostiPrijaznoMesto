(function (exports, $) {
  ...
  AppConfig = {
    idle: 0,
    level: 0,
    message: 'Za delovanje spletnega mesta moramo na vaš računalnik shraniti majhne neškodljive datoteke - piškotke.<br/>Po zakonodaji EU moramo pridobiti vašo privolitev. Se strinjate?',
	cancel: 'Se strinjam',
	changeSettings: 'Spremeni nastavitve',
	linkText: 'Preberi več o piškotkih',
    functionalList: {
        'strict': {
