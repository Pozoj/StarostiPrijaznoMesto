    ...
    execute(
        "CREATE VIEW super_admin_table_v AS
          SELECT  original_posts.id AS original_posts_id, 
                  original_posts.created_at AS original_post_created_at, 
                  original_posts.first_name AS questioners_first_name, 
                  original_posts.last_name AS questioners_last_name, 
                  ...
                  users.id AS responders_id, 
                  users.first_name AS responders_first_name, 
                  users.last_name AS responders_last_name, 
