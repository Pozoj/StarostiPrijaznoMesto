class CreateDatabaseViewForPublicPosts < ActiveRecord::Migration
  def up
    execute(
    ...
    AND answers.answer_status = 'institutionalized'
    OR answers.answer_status = 'answered'")
  end

  def down
    execute("DROP VIEW public_posts_v;") if self.table_exists?("public_posts_v")
